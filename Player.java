...
public class Player {
    ...
    public void move(double g) {
        ...
        speed.y += g;//прибавляет к у скорость ускорения
        pos.add(speed);//к координатам добавляет скорость 
        double airLoss = 0.004;
        speed.mul(1 - airLoss);// отнять что-то меньше единицы чтобы было реалистичнее
    }
